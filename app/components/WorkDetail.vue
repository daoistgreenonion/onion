  ...
  <main class="max-w-5xl mx-auto py-12 px-4">
    ...
    <section class="grid grid-cols-1 sm:grid-cols-[4fr,5fr]">
      ...
      <div class="p-3 flex flex-col justify-between">
        ...
        <!-- Tags -->
        <div class="grid grid-cols-[1fr,6fr] gap-y-4 my-3 text-[10px] sm:text-[16px]">
          ...
          <p class="mr-2 items-start font-bold">Tags:</p>
          <ul v-if="work.tags" class="flex flex-wrap gap-2">
        ...
        <div class="flex bg-gray-200 dark:bg-dark2 p-3 justify-between items-center">
          ...
          <div v-if="!work.externalLink && firstChapter">
            <NuxtLink
              :to="`${chapterBasePath}/${firstChapter.slug}`"
              class="flex items-center gap-2 w-full p-2 sm:px-5 sm:py-2.5 bg-brand hover:bg-brand-light transition-colors text-gray-100"
            >
          ...
          <div v-else-if="work.externalLink">
            <a
              ...
              class="inline-flex items-center gap-2 w-full px-3 py-2 sm:px-5 sm:py-2.5 bg-brand hover:bg-brand-light transition-colors text-gray-100"
            >
              <!-- <img src="/images/wn-b.svg" alt="WN" className='w-5 h-5 inline-block dark:hidden'/>  -->
              <img src="/images/wn-w.svg" alt="WN" className='w-7 h-7'/>
              Read on Webnovel
            </a>
          </div>
    ...
    <section v-if="!work.externalLink">
